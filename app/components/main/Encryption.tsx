    ...
    <section className="relative py-20 overflow-hidden">
      <div className="relative z-10 max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Right - Video Background with Lock */}
          <motion.div
          ...
          >
            {/* Video Background - Full opacity on right side */}
            ...
            <div className="relative z-10 flex flex-col items-center justify-center">
              ...
              <div className="relative w-[250px] h-[250px] md:w-[300px] md:h-[300px] flex items-center justify-center">
                ...
                <motion.div
                  ...
                  className="absolute inset-[15px] rounded-full border border-purple-500/30"
                />
                ...
                {[...Array(6)].map((_, i) => (
                  <motion.div
                    ...
                    style={{
                      top: `${20 + Math.sin(i * 1.1) * 30 + 30}%`,
                      left: `${20 + Math.cos(i * 1.1) * 30 + 30}%`,
                    }}
                    animate={{
                      y: [0, -20, 0],
                      opacity: [0.4, 1, 0.4],
