...
const certificates = [
  ...
  },
  {
    ...
    issuer: "Microsoft",
    date: "2024-04-20",
    description: "Covers core AI concepts, Azure AI services, machine learning models, and responsible AI principles, taught by Microsoft experts.",
  ...
  },
  {
    ...
    issuer: "Udemy",
    date: "2024-03-30",
    description: "Teaches front-end and back-end development using React, Node.js, Express, and MongoDB to build scalable web applications, instructed by Angela Yu.",
  ...
  },
  {
    ...
    date: "2024-02-15",
    description: "Focuses on writing complex SQL queries, optimizing database performance, and using advanced relational database techniques, guided by Coursera instructors.",
